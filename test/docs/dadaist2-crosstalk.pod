=head1 dadaist2-crosstalk

B<dadaist2-crosstalk> is an open source implementation of the
UNCROSS2 (L<https://www.biorxiv.org/content/10.1101/400762v1.full.pdf>)
